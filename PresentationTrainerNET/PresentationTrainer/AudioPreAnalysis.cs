...
namespace PresentationTrainer
{
    ...
    {
        public float ThresholdIsSpeaking = 0.25f;
        public float ThresholdIsSpeakingLoud= 0.65f;
        public float ThresholdIsSpeakingVeryLoud= 0.75f;
        public float ThresholdIsSpeakingSoft=0.32f;
        public float ThresholdIsSpeakingVerySoft=0.28f;
